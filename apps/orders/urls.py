...
router.register(r'company', views.Orders_Company, basename='order-company')
router.register(r'customer', views.Orders_Customer, basename='order-customer')
router.register(r'previous-products', views.Previous_Products_asJSON, basename='previous-products')
router.register(r'flags', views.Order_Flags_asJSON)
router.register(r'ordertotal', views.OrderTotalsViewSet)
router.register(r'order-list-company', views.Orders_Company, basename='order-list-company')
...
urlpatterns = [
   ...
   # path('product/<int:product_id>/ajax_load_options_test/', views.ajax_product_options_test, name='product_variant_ajax_options_test'),
    ...
    path('awaiting-artwork', views.awaiting_artwork_order_list, name='awaitingartworkorders'),
    path('supplier-items', views.supplier_items_order_list, name='supplieritemorders'),
    path('ready-to-collect', views.ready_to_collect_order_list, name='readytocollectorders'),
