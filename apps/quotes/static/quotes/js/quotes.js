            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        let edit_icon = '<a class="btn btn-primary btn-sm js-quote-product-edit" role="button" data-url="' + current_quote_id + '/product/edit/' + data + '" data-dlgsize="modal-xl"><i class="fas fa-edit fa-sm"></i></a>';
                        let delete_icon = '<a class="btn btn-danger btn-sm js-quote-product-edit" role="button" data-url="' + current_quote_id + '/product/delete/' + data + '" data-dlgsize="modal-sm"><i class="fas fa-trash fa-sm"></i></a>'
