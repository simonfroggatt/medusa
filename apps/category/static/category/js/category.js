    ...
    $('#category_description_table').DataTable( {
        ...
        columns :[
            ...
            {data: "description"},
            {
                ...
                render: function ( data, type, row ) {
                let edit_icon = '<a class="btn btn-primary btn-sm" href="' +data  + '/storeeditpk'+'"><i class="fas fa-edit fa-sm"></i></a>';
                let delete_icon = '<a  class="btn btn-danger btn-sm js-category-edit" role="button" data-url="api/storetextdelete/'+data+'" data-dlgsize="modal-sm"><i class="fas fa-trash fa-sm"></i></a>';
    ...
    $('#category_site_parent_table').DataTable( {
        ...
        columns :[
                ...
                },
            {
                ...
                className: 'text-md-end text-start',
                render: function ( data, type, row ) {
                let edit_icon = '<a class="btn btn-primary btn-sm js-category-edit" role="button" data-url="'+data+'/storecatparentdlg"><i class="fas fa-edit fa-sm"></i></a>';
                let delete_icon = '<a  class="btn btn-danger btn-sm js-category-edit" role="button" data-url="api/storeparentdelete/'+data+ '" data-dlgsize="modal-lg"><i class="fas fa-trash fa-sm"></i></a>';
                return  edit_icon + " " + delete_icon;
